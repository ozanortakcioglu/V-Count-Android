...
public class Visitor_Analysis extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance){
        final View rootView = inflater.inflate(R.layout.visitor_analysis,container,false);
